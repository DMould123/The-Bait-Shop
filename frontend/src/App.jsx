  ...
  const fullCalendar = [
    {
      ...
      price: '$25',
      blurb:
        'Las Vegas\' rising stars, The Killers, are on the verge of taking the world by storm! Their debut album, Hot Fuss, featuring iconic singles like "Mr. Brightside" and "Somebody Told Me," has captivated fans and critics alike. Praised by NME as "irresistibly stylish," they\'ve been making waves on shows like Late Night with Conan O\'Brien and The Tonight Show with Jay Leno. Don\'t miss their electric energy live at The Bait Shop!',
    ...
    },
    {
      ...
      price: '$40',
      blurb:
        'Washington\'s indie rock favorites, Death Cab for Cutie, bring their emotive sound to The Bait Shop! Their critically acclaimed album Transatlanticism has garnered praise from Rolling Stone and Pitchfork, with standout tracks like "The Sound of Settling" and "Title and Registration". The band recently performed on The Late Late Show with Craig Kilborn, cementing their status as a must-see act.',
    ...
    },
    {
      ...
      price: '$20',
      blurb:
        'California\'s own Rooney are bringing their sun-soaked melodies and retro vibes to The Bait Shop! Their self-titled debut album features hits like "Blueside" and "I\'m Shakin\'." With praise from Spin and appearances on Carson Daly and David Letterman, Rooney is quickly becoming a name to watch in the indie scene.',
    ...
    },
    {
      ...
      price: '$18',
      blurb:
        'Catch London\'s genre-bending sensation Tom Vek at The Bait Shop! His debut album We Have Sound features innovative tracks like "C-C (You Set the Fire in Me)" and "If You Want." Hailed by NME as "the future of indie music," Tom\'s dynamic live performances have also made waves on BBC\'s Later... with Jools Holland.',
  ...
  return (
    <Router>
      <div className="min-h-screen bg-gray-100">
        <Navbar events={fullCalendar} fullCalendar={fullCalendar} />

  ...
  return (
    <div className="py-8 bg-gray-50">
      ...
      <div className="prose max-w-none text-gray-700 mb-8">
        ...
        <p>
          Since our opening, we have quickly become a significant part of the local cultural landscape, and we invite you to be part of our journey. Whether you're here for a concert, a night out with friends, or simply to enjoy the atmosphere, The Bait Shop promises unforgettable moments.
        </p>
      </div>

      {/* Images Section */}
      <div className="flex flex-col items-center mb-8">
        <img src={baitShopImage} alt="The Bait Shop" className="w-full h-auto rounded-lg shadow-md mb-4" />
        <div className="flex space-x-4">
          <img src={baitShopImage1} alt="Bait Shop Interior" className="w-1/2 h-auto rounded-lg shadow-md" />
          <img src={baitShopImage2} alt="Bait Shop Event" className="w-1/2 h-auto rounded-lg shadow-md" />
        </div>
      </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        ...
        <form action="https://formspree.io/f/mjvdqpav" method="POST" className="flex flex-col">
          ...
          />
          <button type="submit" className="bg-gray-800 hover:bg-gray-900 text-white py-2 rounded-lg transition-colors">
            Subscribe
          </button>
        </form>
      </div>

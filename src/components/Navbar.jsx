      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-24">
          ...
          <div className="hidden md:flex md:items-center md:space-x-8">
            <Link to="/calendar" className="text-white hover:text-orange-300 px-3 py-2 text-base font-medium">
              Calendar
            </Link>
            <Link to="/restaurant" className="text-white hover:text-orange-300 px-3 py-2 text-base font-medium">
              Restaurant
            </Link>
            <Link to="/faqs" className="text-white hover:text-orange-300 px-3 py-2 text-base font-medium">
              FAQs
            </Link>
            <Link to="/about" className="text-white hover:text-orange-300 px-3 py-2 text-base font-medium">
              About Us
            </Link>
          </div>
